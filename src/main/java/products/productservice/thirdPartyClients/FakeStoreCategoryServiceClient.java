...
import products.productservice.services.FakeStoreCategoryService;
...
public class FakeStoreCategoryServiceClient {
    ...
    @Autowired
    public FakeStoreCategoryServiceClient(RestTemplateBuilder restTemplateBuilder, @Value("https://fakestoreapi.com") String fakeStoreBaseUrl, @Value("/products") String productUrl, @Value("/category") String getInCategoryUrl, @Value("/categories") String getAllCategoriesUrl) {
